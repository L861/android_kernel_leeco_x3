...
#define DIFFERENCE_HWOCV_SWOCV		10	/* 10% difference */
#endif
...
// add begin by weijun@20151029
#ifdef USING_SMOOTH_UI_SOC2
kal_int32 temp_UI_SOC2 = -1;
kal_int32 pre_UI_SOC2 = 0;
kal_int32 UI_SOC3 = 0;
kal_int32 pre_cc_act = 0;
#endif
// add end
...
PMU_BatteryidStruct BatteryId_status;
...
void fgauge_get_profile_id(void)
{
	...
	id_volt = PMIC_IMM_GetOneChannelValue(AUX_ADCVIN0_AP, 1, 0);  /*[---Modify Rachel, support 2nd battery,20141208---]*/
	...
	BatteryId_status.adcChannel = BATTERY_ID_CHANNEL_NUM;
	BatteryId_status.adcChannelVol = id_volt;
	BatteryId_status.batteryId = g_fg_battery_id;
...
int __batt_meter_init_cust_data_from_cust_header(struct platform_device *dev)
{
	...
	batt_meter_table_cust_data.battery_profile_t0_size =
	    sizeof(battery_profile_t0[g_fg_battery_id]) / sizeof(BATTERY_PROFILE_STRUC);

	memcpy(&batt_meter_table_cust_data.battery_profile_t0,
	       &battery_profile_t0[g_fg_battery_id], sizeof(battery_profile_t0[g_fg_battery_id]));

	batt_meter_table_cust_data.battery_profile_t1_size =
	    sizeof(battery_profile_t1[g_fg_battery_id]) / sizeof(BATTERY_PROFILE_STRUC);

	memcpy(&batt_meter_table_cust_data.battery_profile_t1,
	       &battery_profile_t1[g_fg_battery_id], sizeof(battery_profile_t1[g_fg_battery_id]));

	batt_meter_table_cust_data.battery_profile_t2_size =
	    sizeof(battery_profile_t2[g_fg_battery_id]) / sizeof(BATTERY_PROFILE_STRUC);

	memcpy(&batt_meter_table_cust_data.battery_profile_t2,
	       &battery_profile_t2[g_fg_battery_id], sizeof(battery_profile_t2[g_fg_battery_id]));

	batt_meter_table_cust_data.battery_profile_t3_size =
	    sizeof(battery_profile_t3[g_fg_battery_id]) / sizeof(BATTERY_PROFILE_STRUC);

	memcpy(&batt_meter_table_cust_data.battery_profile_t3,
	       &battery_profile_t3[g_fg_battery_id], sizeof(battery_profile_t3[g_fg_battery_id]));

	batt_meter_table_cust_data.r_profile_t0_size =
	    sizeof(r_profile_t0[g_fg_battery_id]) / sizeof(R_PROFILE_STRUC);

	memcpy(&batt_meter_table_cust_data.r_profile_t0,
	       &r_profile_t0[g_fg_battery_id], sizeof(r_profile_t0[g_fg_battery_id]));

	batt_meter_table_cust_data.r_profile_t1_size =
	    sizeof(r_profile_t1[g_fg_battery_id]) / sizeof(R_PROFILE_STRUC);

	memcpy(&batt_meter_table_cust_data.r_profile_t1,
	       &r_profile_t1[g_fg_battery_id], sizeof(r_profile_t1[g_fg_battery_id]));

	batt_meter_table_cust_data.r_profile_t2_size =
	    sizeof(r_profile_t2[g_fg_battery_id]) / sizeof(R_PROFILE_STRUC);

	memcpy(&batt_meter_table_cust_data.r_profile_t2,
	       &r_profile_t2[g_fg_battery_id], sizeof(r_profile_t2[g_fg_battery_id]));

	batt_meter_table_cust_data.r_profile_t3_size =
	    sizeof(r_profile_t3[g_fg_battery_id]) / sizeof(R_PROFILE_STRUC);

	memcpy(&batt_meter_table_cust_data.r_profile_t3,
	       &r_profile_t3[g_fg_battery_id], sizeof(r_profile_t3[g_fg_battery_id]));

#else

	batt_meter_table_cust_data.battery_profile_t0_size =
	    sizeof(battery_profile_t0) / sizeof(BATTERY_PROFILE_STRUC);

	memcpy(&batt_meter_table_cust_data.battery_profile_t0,
	       &battery_profile_t0, sizeof(battery_profile_t0));

	batt_meter_table_cust_data.battery_profile_t1_size =
	    sizeof(battery_profile_t1) / sizeof(BATTERY_PROFILE_STRUC);

	memcpy(&batt_meter_table_cust_data.battery_profile_t1,
	       &battery_profile_t1, sizeof(battery_profile_t1));

	batt_meter_table_cust_data.battery_profile_t2_size =
	    sizeof(battery_profile_t2) / sizeof(BATTERY_PROFILE_STRUC);

	memcpy(&batt_meter_table_cust_data.battery_profile_t2,
	       &battery_profile_t2, sizeof(battery_profile_t2));

	batt_meter_table_cust_data.battery_profile_t3_size =
	    sizeof(battery_profile_t3) / sizeof(BATTERY_PROFILE_STRUC);

	memcpy(&batt_meter_table_cust_data.battery_profile_t3,
	       &battery_profile_t3, sizeof(battery_profile_t3));

	batt_meter_table_cust_data.r_profile_t0_size =
	    sizeof(r_profile_t0) / sizeof(R_PROFILE_STRUC);

	memcpy(&batt_meter_table_cust_data.r_profile_t0, &r_profile_t0, sizeof(r_profile_t0));

	batt_meter_table_cust_data.r_profile_t1_size =
	    sizeof(r_profile_t1) / sizeof(R_PROFILE_STRUC);

	memcpy(&batt_meter_table_cust_data.r_profile_t1, &r_profile_t1, sizeof(r_profile_t1));

	batt_meter_table_cust_data.r_profile_t2_size =
	    sizeof(r_profile_t2) / sizeof(R_PROFILE_STRUC);

	memcpy(&batt_meter_table_cust_data.r_profile_t2, &r_profile_t2, sizeof(r_profile_t2));
	batt_meter_table_cust_data.r_profile_t3_size =
	    sizeof(r_profile_t3) / sizeof(R_PROFILE_STRUC);
...
kal_int32 battery_meter_get_charger_voltage(void)
{
	...
	printk("error: battery meter has not init!\n");
...
// add begin by weijun@20151029
#ifdef USING_SMOOTH_UI_SOC2
kal_int32 battery_meter_smooth_uisoc2(void)
{
	static int init_flag = -1;
	kal_int32 smooth_cc = 0;
	kal_int32 cc_act = 0;
	kal_int32 cc_act_delta = 0;
	...
	if (gFG_coulomb_is_charging == 1) {
		...
		if ((cc_act_delta > smooth_cc) && UI_SOC3 < 100) {
			UI_SOC3++;
			pre_cc_act = cc_act;
			bm_print(BM_LOG_CRTI, "smooth_UISOC2-###+++UI_SOC3=%d\n", UI_SOC3);
		}
	} else {
		// discharging
	...
	if ((UI_SOC3 >= temp_UI_SOC2) || (BMT_status.bat_full == true) || (temp_UI_SOC2 == 1)) {
		UI_SOC3 = temp_UI_SOC2;
	}

	BMT_status.UI_SOC2 = UI_SOC3;
	
	bm_print(BM_LOG_CRTI, "smooth_UISOC2-@@@@@@@%d,%d,%d,%d,%d,%d,%d,%d\n",
						  ...
						  const char *buf, size_t size)
{
	...
	if (buf != NULL && size != 0) {
		...
		bm_print(BM_LOG_CRTI,
			 "[store_FG_suspend_current_threshold] suspend_current_threshold=%d\n",
			 suspend_current_threshold);
	}
	return size;
}
						  ...
						  const char *buf, size_t size)
{
	...
	if (buf != NULL && size != 0) {
		...
		bm_print(BM_LOG_CRTI,
			 "[store_difference_voltage_update] difference_voltage_update=%d\n",
...
static int battery_meter_suspend(struct platform_device *dev, pm_message_t state)
{
...
#elif defined(SOC_BY_SW_FG) || defined(SOC_BY_HW_FG)
	{
		...
		bm_print(BM_LOG_CRTI,
			 "[battery_meter_suspend]2. sleep_total_time = %d, last_time = %d\n",
...
#endif
	battery_log(BAT_LOG_CRTI,
		    "******** battery_meter_resume!! ******** suspend_time %d smooth_time %d g_spm_timer %d\n",
...
void bmd_ctrl_cmd_from_user(void *nl_data, struct fgd_nl_msg_t *ret_msg)
{
	...
	case FG_DAEMON_CMD_GET_INIT_FLAG:
		{
			...
			bm_print(BM_LOG_FULL, "[fg_res] init_flag = %d\n", init_flag);
		}
		break;
	...
	case FG_DAEMON_CMD_GET_SOC:
		{
			...
			bm_print(BM_LOG_FULL, "[fg_res] gFG_capacity_by_c = %d\n",
				 gFG_capacity_by_c);
		}
		break;
	...
	case FG_DAEMON_CMD_GET_DOD0:
		{
			...
			bm_print(BM_LOG_FULL, "[fg_res] gFG_DOD0 = %d\n", gFG_DOD0);
		}
		break;
	...
	case FG_DAEMON_CMD_GET_DOD1:
		{
			...
			bm_print(BM_LOG_FULL, "[fg_res] gFG_DOD1 = %d\n", gFG_DOD1);
		}
		break;
	...
	case FG_DAEMON_CMD_GET_HW_OCV:
		{
			...
			bm_print(BM_LOG_FULL, "[fg_res] voltage = %d\n", voltage);
			gFG_hwocv = voltage;
		}
		break;
	...
	case FG_DAEMON_CMD_GET_HW_FG_INIT_CURRENT:
		{
			...
			bm_print(BM_LOG_FULL, "[fg_res] fg_current = %d\n", gFG_current_init);
	...
	case FG_DAEMON_CMD_GET_HW_FG_INIT_CURRENT_SIGN:
		{
			...
			bm_print(BM_LOG_FULL, "[fg_res] current_state = %d\n",
	...
	case FG_DAEMON_CMD_GET_HW_FG_CAR_ACT:
		{
			...
			bm_print(BM_LOG_FULL, "[fg_res] fg_coulomb = %d\n", fg_coulomb);
	...
	case FG_DAEMON_CMD_GET_TEMPERTURE:
		{
			...
			bm_print(BM_LOG_FULL, "[fg_res] update = %d\n", update);
			temperture = force_get_tbat(update);
			bm_print(BM_LOG_FULL, "[fg_res] temperture = %d\n", temperture);
	...
	case FG_DAEMON_CMD_CHARGING_ENABLE:
		{
			...
			bm_print(BM_LOG_FULL, "[fg_res] charging_enable = %d\n", charging_enable);
		}
		break;
	...
	case FG_DAEMON_CMD_FGADC_RESET:
		bm_print(BM_LOG_FULL, "[fg_res] fgadc_reset\n");
		battery_meter_ctrl(BATTERY_METER_CMD_HW_RESET, NULL);
			// add begin by weijun@20151031
			#ifdef USING_SMOOTH_UI_SOC2
			pre_cc_act = 0;
			#endif
			// add end
	...
	case FG_DAEMON_CMD_GET_BATTERY_PLUG_STATUS:
		{
			...
			/* bm_print(BM_LOG_CRTI, " ret_msg->fgd_data_len %d\n",ret_msg->fgd_data_len); */
			bm_print(BM_LOG_FULL, "[fg_res] plugout_status = %d\n", plugout_status);
	...
	case FG_DAEMON_CMD_GET_RTC_SPARE_FG_VALUE:
		{
			...
			/* bm_print(BM_LOG_CRTI, " ret_msg->fgd_data_len %d\n",ret_msg->fgd_data_len); */
			bm_print(BM_LOG_FULL, "[fg_res] rtc_fg_soc = %d\n", rtc_fg_soc);
		}
		break;
	...
	case FG_DAEMON_CMD_IS_CHARGER_EXIST:
		{
			...
			bm_print(BM_LOG_FULL, "[fg_res] charger_exist = %d\n", charger_exist);
		}
		break;
	...
	case FG_DAEMON_CMD_IS_BATTERY_FULL:
		{
			...
			bm_print(BM_LOG_FULL, "[fg_res] battery_full = %d\n", battery_full);
		}
		break;
	...
	case FG_DAEMON_CMD_GET_BOOT_REASON:
		{
			...
			bm_print(BM_LOG_FULL, "[fg_res] g_boot_reason = %d\n", g_boot_reason);
		}
		break;
	...
	case FG_DAEMON_CMD_GET_CHARGING_CURRENT:
		{
			...
			bm_print(BM_LOG_FULL, "[fg_res] ICharging = %d\n", ICharging);
		}
		break;
	...
	case FG_DAEMON_CMD_GET_CHARGER_VOLTAGE:
		{
			...
			bm_print(BM_LOG_FULL, "[fg_res] charger_vol = %d\n", charger_vol);
		}
		break;
	...
	case FG_DAEMON_CMD_GET_SHUTDOWN_COND:
		{
			...
			bm_print(BM_LOG_FULL, "[fg_res] shutdown_cond = %d\n", shutdown_cond);
		}
		break;
	...
	case FG_DAEMON_CMD_GET_CUSTOM_SETTING:
		{
			...
			bm_print(BM_LOG_FULL, "[fg_res] version = %d\n", version);
	...
	case FG_DAEMON_CMD_GET_UI_SOC:
		{
			...
			bm_print(BM_LOG_FULL, "[fg_res] ui soc = %d\n", BMT_status.UI_SOC);
		}
		break;
	...
	case FG_DAEMON_CMD_GET_CV_VALUE:
		{
			...
			bm_print(BM_LOG_FULL, "[fg_res] cv value = %d\n", cv_voltage);
		}
		break;
	...
	case FG_DAEMON_CMD_GET_DURATION_TIME:
		{
			...
			bm_print(BM_LOG_FULL, "[fg_res] duration_type = %d\n", duration_type);
			...
			bm_print(BM_LOG_FULL, "[fg_res] duration time = %d\n", duration_time);
		}
		break;
	...
	case FG_DAEMON_CMD_GET_TRACKING_TIME:
		{
			...
			bm_print(BM_LOG_FULL, "[fg_res] tracking time = %d\n",
	...
	case FG_DAEMON_CMD_GET_CURRENT_TH:
		{
			...
			bm_print(BM_LOG_FULL, "[fg_res] suspend_current_threshold = %d\n",
				 suspend_current_threshold);
		}
		break;
	...
	case FG_DAEMON_CMD_GET_CHECK_TIME:
		{
			...
			bm_print(BM_LOG_FULL, "[fg_res] check time = %d\n", ocv_check_time);
		}
		break;
	...
	case FG_DAEMON_CMD_GET_DIFFERENCE_VOLTAGE_UPDATE:
		{
			...
			bm_print(BM_LOG_FULL, "[fg_res] difference_voltage_update = %d\n",
				 difference_voltage_update);
		}
		break;
	...
	case FG_DAEMON_CMD_GET_AGING1_LOAD_SOC:
		{
			...
			bm_print(BM_LOG_FULL, "[fg_res] aging1_load_soc = %d\n", aging1_load_soc);
		}
		break;
	...
	case FG_DAEMON_CMD_GET_AGING1_UPDATE_SOC:
		{
			...
			bm_print(BM_LOG_FULL, "[fg_res] aging1_update_soc = %d\n",
				 aging1_update_soc);
		}
		break;
	...
	case FG_DAEMON_CMD_GET_SHUTDOWN_SYSTEM_VOLTAGE:
		{
			...
			bm_print(BM_LOG_FULL, "[fg_res] shutdown_system_voltage = %d\n",
				 shutdown_system_voltage);
		}
		break;
	...
	case FG_DAEMON_CMD_GET_CHARGE_TRACKING_TIME:
		{
			...
			bm_print(BM_LOG_FULL, "[fg_res] charge_tracking_time = %d\n",
				 charge_tracking_time);
		}
		break;
	...
	case FG_DAEMON_CMD_GET_DISCHARGE_TRACKING_TIME:
		{
			...
			bm_print(BM_LOG_FULL, "[fg_res] discharge_tracking_time = %d\n",
				 discharge_tracking_time);
		}
		break;
	...
	case FG_DAEMON_CMD_GET_SHUTDOWN_GAUGE0:
		{
			...
			bm_print(BM_LOG_FULL, "[fg_res] shutdown_gauge0 = %d\n", shutdown_gauge0);
		}
		break;
	...
	case FG_DAEMON_CMD_GET_SHUTDOWN_GAUGE1_XMINS:
		{
			...
			bm_print(BM_LOG_FULL, "[fg_res] shutdown_gauge1_xmins = %d\n",
				 shutdown_gauge1_xmins);
		}
		break;
	...
	case FG_DAEMON_CMD_GET_SHUTDOWN_GAUGE1_MINS:
		{
			...
			bm_print(BM_LOG_FULL, "[fg_res] shutdown_gauge1_mins = %d\n",
				 shutdown_gauge1_mins);
		}
		break;

	case FG_DAEMON_CMD_SET_SUSPEND_TIME:
		bm_print(BM_LOG_FULL, "[fg_res] set suspend time\n");
	...
	case FG_DAEMON_CMD_SET_WAKEUP_SMOOTH_TIME:
		{
			...
			bm_print(BM_LOG_FULL, "[fg_res] wake_up_smooth_time = %d\n",
				 wake_up_smooth_time);
		}
		break;
	...
	case FG_DAEMON_CMD_SET_IS_CHARGING:
		{
			...
			bm_print(BM_LOG_FULL, "[fg_res] is_charging = %d\n",
	...
	case FG_DAEMON_CMD_SET_RBAT:
		{
			...
			bm_print(BM_LOG_FULL, "[fg_res] gFG_resistance_bat = %d\n",
				 gFG_resistance_bat);
		}
		break;
	...
	case FG_DAEMON_CMD_SET_SWOCV:
		{
			...
			bm_print(BM_LOG_FULL, "[fg_res] gFG_voltage = %d\n", gFG_voltage);
		}
		break;
	...
	case FG_DAEMON_CMD_SET_QMAX:
		{
			...
			bm_print(BM_LOG_FULL, "[fg_res] QMAX = %d\n", gFG_BATT_CAPACITY_aging);
		}
		break;
	...
	case FG_DAEMON_CMD_SET_BATTERY_FULL:
		{
			...
			bm_print(BM_LOG_FULL, "[fg_res] set bat_full = %d\n", BMT_status.bat_full);
		}
		break;
	...
	case FG_DAEMON_CMD_SET_RTC:
		{
			...
			bm_print(BM_LOG_FULL, "[fg_res] set rtc = %d\n", rtcvalue);
		}
		break;
	...
	case FG_DAEMON_CMD_SET_POWEROFF:
		{
			...
			bm_print(BM_LOG_FULL, "[fg_res] FG_DAEMON_CMD_SET_POWEROFF\n");
	...
	case FG_DAEMON_CMD_IS_KPOC:
		{
			...
			bm_print(BM_LOG_FULL, "[fg_res] query kpoc = %d\n", kpoc);
		}
		break;
	...
	case FG_DAEMON_CMD_SET_SOC:
		{
			...
			bm_print(BM_LOG_FULL, "[fg_res] SOC = %d\n", gFG_capacity_by_c);
	...
	case FG_DAEMON_CMD_SET_UI_SOC:
		{
			...
			bm_print(BM_LOG_FULL, "[fg_res] UI_SOC = %d\n", UI_SOC);
	...
	case FG_DAEMON_CMD_SET_UI_SOC2:
		{
			INT32 UI_SOC;
			memcpy(&UI_SOC, &msg->fgd_data[0], sizeof(UI_SOC));
			bm_print(BM_LOG_FULL, "[fg_res] UI_SOC2 = %d\n", UI_SOC);
			// modify begin by weijun@20151029
			#ifdef USING_SMOOTH_UI_SOC2
			temp_UI_SOC2 = UI_SOC;
			#else
...
/*
			...
			bm_print(BM_LOG_FULL, "[fg_res] OAM_V_OCV = %d\n", tmp);
			oam_v_ocv = tmp;
*/
		}
		break;
...
/*
			...
			memcpy(&tmp, &msg->fgd_data[0], sizeof(tmp));
			bm_print(BM_LOG_FULL, "[fg_res] OAM_R = %d\n", tmp);
			oam_r = tmp;
*/
		}
		break;
...
/*
			...
			bm_print(BM_LOG_FULL, "[fg_res] suspend_time = %d\n", swfg_ap_suspend_time);
...
/*
			...
			bm_print(BM_LOG_FULL, "[fg_res] is_hwocv_update = %d\n", is_hwocv_update);
