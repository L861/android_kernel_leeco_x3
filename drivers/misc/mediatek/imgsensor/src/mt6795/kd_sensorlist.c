...
/* Move these defines to kd_camera_hw.h, so they can be project-dependent
#define SUPPORT_I2C_BUS_NUM1        0
#define SUPPORT_I2C_BUS_NUM2        2
*/
/* The following is to avoid build error of project that dose not define BUS_NUMBER */
#if !defined(SUPPORT_I2C_BUS_NUM1) || !defined(SUPPORT_I2C_BUS_NUM2)
    #define SUPPORT_I2C_BUS_NUM1    0
    #define SUPPORT_I2C_BUS_NUM2    2
#endif
...
inline static int kdSetSensorGpio(int *pBuf)
{
    ...
    /* / GPIO defines must generate by DCT tools and they are chip-dependent. */
    /* / You should check these defines with DCT tool owner before chip sample back */
    if (pSensorgpio->SensroInterfaceType == SENSORIF_PARALLEL)
    {
	if (pSensorgpio->GpioEnable == 1)
	{
	    mt_set_gpio_mode(GPIO_CAMERA_RDP0_A_PIN, GPIO_CAMERA_RDP0_A_PIN_M_CMDAT); /* CMDAT2 */
	    mt_set_gpio_mode(GPIO_CAMERA_RDN0_A_PIN, GPIO_CAMERA_RDN0_A_PIN_M_CMDAT); /* CMDAT3 */
	    mt_set_gpio_mode(GPIO_CAMERA_RDP1_A_PIN, GPIO_CAMERA_RDP1_A_PIN_M_CMDAT); /* CMDAT4 */
	    mt_set_gpio_mode(GPIO_CAMERA_RDN1_A_PIN, GPIO_CAMERA_RDN1_A_PIN_M_CMDAT); /* CMDAT5 */
	    mt_set_gpio_mode(GPIO_CAMERA_RCP_A_PIN, GPIO_CAMERA_RCP_A_PIN_M_CMDAT); /* CMDAT6 */
	    mt_set_gpio_mode(GPIO_CAMERA_RCN_A_PIN, GPIO_CAMERA_RCN_A_PIN_M_CMDAT); /* CMDAT7 */
	    mt_set_gpio_mode(GPIO_CAMERA_RDP2_A_PIN, GPIO_CAMERA_RDP2_A_PIN_M_CMDAT); /* CMDAT8 */
	    mt_set_gpio_mode(GPIO_CAMERA_RDN2_A_PIN, GPIO_CAMERA_RDN2_A_PIN_M_CMDAT); /* CMDAT9 */
	    mt_set_gpio_mode(GPIO_CAMERA_RDP3_A_PIN, GPIO_CAMERA_RDP3_A_PIN_M_CMHSYNC); /* CMHSYNC */
	    mt_set_gpio_mode(GPIO_CAMERA_RDN3_A_PIN, GPIO_CAMERA_RDN3_A_PIN_M_CMVSYNC); /* CMVSYNC */


	    if (pSensorgpio->SensorIndataformat  == DATA_10BIT_FMT) {/* 10bit data pin */
		mt_set_gpio_mode(GPIO_CAMERA_RCP_B_PIN, GPIO_CAMERA_RCP_B_PIN_M_CMDAT); /* CMDAT1 */
		mt_set_gpio_mode(GPIO_CAMERA_RCN_B_PIN, GPIO_CAMERA_RCN_B_PIN_M_CMDAT); /* CMDAT0 */
	    }
	}
	else
	{
	    mt_set_gpio_mode(GPIO_CAMERA_RDP0_A_PIN, GPIO_CAMERA_RDP0_A_PIN_M_GPIO); /* CMDAT2 */
	    mt_set_gpio_mode(GPIO_CAMERA_RDN0_A_PIN, GPIO_CAMERA_RDN0_A_PIN_M_GPIO); /* CMDAT3 */
	    mt_set_gpio_mode(GPIO_CAMERA_RDP1_A_PIN, GPIO_CAMERA_RDP1_A_PIN_M_GPIO); /* CMDAT4 */
	    mt_set_gpio_mode(GPIO_CAMERA_RDN1_A_PIN, GPIO_CAMERA_RDN1_A_PIN_M_GPIO); /* CMDAT5 */
	    mt_set_gpio_mode(GPIO_CAMERA_RCP_A_PIN, GPIO_CAMERA_RCP_A_PIN_M_GPIO); /* CMDAT6 */
	    mt_set_gpio_mode(GPIO_CAMERA_RCN_A_PIN, GPIO_CAMERA_RCN_A_PIN_M_GPIO); /* CMDAT7 */
	    mt_set_gpio_mode(GPIO_CAMERA_RDP2_A_PIN, GPIO_CAMERA_RDP2_A_PIN_M_GPIO); /* CMDAT8 */
	    mt_set_gpio_mode(GPIO_CAMERA_RDN2_A_PIN, GPIO_CAMERA_RDN2_A_PIN_M_GPIO); /* CMDAT9 */
	    mt_set_gpio_mode(GPIO_CAMERA_RDP3_A_PIN, GPIO_CAMERA_RDP3_A_PIN_M_GPIO); /* CMHSYNC */
	    mt_set_gpio_mode(GPIO_CAMERA_RDN3_A_PIN, GPIO_CAMERA_RDN3_A_PIN_M_GPIO); /* CMVSYNC */
	    mt_set_gpio_mode(GPIO_CAMERA_RCP_B_PIN, GPIO_CAMERA_RCP_B_PIN_M_GPIO); /* CMDAT1 */
	    mt_set_gpio_mode(GPIO_CAMERA_RCN_B_PIN, GPIO_CAMERA_RCN_B_PIN_M_GPIO); /* CMDAT0 */
	}
...
)
{
	...
	case KDIMGSENSORIOC_X_SET_GPIO:
        ...
        case KDIMGSENSORIOC_X_GET_ISP_CLK:
            ...
            *(unsigned int*)pBuff = 0;//get_isp_clk();
            break;
