...
#if defined(R69006_DSI_CMD_TRULY_SGM3804)
	&r69006_dsi_cmd_truly_sgm3804_lcm_drv,
#endif

#if defined(NT35596_HD1080_VDO_SHARP_TPS65132)
	&nt35596_hd1080_vdo_sharp_tps65132_lcm_drv,
#endif

#if defined(BOE_NT35596S_DSI_VDO_LP3101)
	&boe_nt35596s_dsi_vdo_lp3101_lcm_drv,
#endif

#if defined(NT36760_DSI_VDO_SGMICRO_SGM3804)
...
#if defined(NT35532_FHD_DSI_VIDEO_SHARP_TPS65132)
    &nt35532_fhd_dsi_video_sharp_tps65132_lcm_drv,
#endif
